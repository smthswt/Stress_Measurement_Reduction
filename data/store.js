...
export const fetchDevices = createAsyncThunk('device/fetchDevices', async (dispatch, getState) => {
...
export const fetchReports = createAsyncThunk('report/fetchReports', async (dispatch, getState) => {
