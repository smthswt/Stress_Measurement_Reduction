...
const PrivacyPolicyScreens = () => {
  return (
    <StackNative.Navigator initialRouteName={PrivacyPolicy}>
      ...
      <StackNative.Screen
        name={'delegation'}
        component={PP_delegation}
        options={crossFadeTransition}
      />
      <StackNative.Screen
        name={'Personal'}
        component={PP_Personal}
        options={crossFadeTransition}
      />
      <StackNative.Screen
        name={'Safety'}
...
const DeviceSettingScreens = () => {
  return (
    <StackNative.Navigator initialRouteName={SettingsView_Device}>
      ...
      <StackNative.Screen
        name={'CompleteEnroll'}
        component={CompleteSearchingDevice}
        options={crossFadeTransition}
      />
    </StackNative.Navigator>
  );
...
const App = () => {
  ...
  const LoginScreens = () => {
    return (
      <StackNative.Navigator
        initialRouteName={onboarded ? 'Login' : 'Onboarding1'}>
        <StackNative.Screen
          name="Onboarding1"
              ...
              <NavigationContainer>
                <VStack flex={1} justifyContent={'space-between'}>
                  <Stack.Navigator
                    ...
                    />
                    <StackNative.Screen
                      name="PrivacyPolicyScreens"
                      component={PrivacyPolicyScreens}
                      options={crossFadeTransition}
                    />
                    <StackNative.Screen
                      name="DeviceSettingScreens"
                      component={DeviceSettingScreens}
                      options={crossFadeTransition}
                    />
                  </Stack.Navigator>
                </VStack>
