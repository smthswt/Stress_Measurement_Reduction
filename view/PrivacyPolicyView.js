import {Box, Center, Divider, FlatList, Heading, HStack, Pressable, Spacer, Text, VStack} from "native-base";
    ...
    return (
        <VStack flex={1}>
            <HStack alignitems={"center"} justifyContent={"flex-start"} bgColor={"white"} padding={5}>
                ...
                <Text bold fontSize={18} marginLeft={3}>개인정보 처리방침</Text>
            </HStack>
            ...
            <VStack flex={1} m={6}>
                ...
                <FlatList
                    ...
                    renderItem={({item, index}) => (
                        ...
                        <Pressable space={2} flex={1} backgroundColor={'white'} paddingY={4} paddingX={6} onPress={() => handlePolicyPress(item.id)}>
